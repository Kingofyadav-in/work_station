...
if b4.button("Doctor",      key="sys_doctor",  use_container_width=True): _run("doctor")

b5, b6, b7, _ = st.columns(4)
if b5.button("Disk",    key="sys_disk",    use_container_width=True): _run("disk")
if b6.button("Battery", key="sys_battery", use_container_width=True): _run("battery")
if b7.button("Website", key="sys_website", use_container_width=True): _run("website status")
